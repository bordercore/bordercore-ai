...
const app = createApp({
    ...
    setup() {
        ...
        function setupCodeCopyObserver() {
            ...
            codeCopyObserver = new MutationObserver((mutations) => {
            ...
            codeCopyObserver.observe(container, {
                childList: true,
                subtree: true,
            });
        };
        ...
        function addMessage(role, message) {
            ...
            nextTick(() => {
                ...
                if (scrollableDiv) {
                    ...
                    addCopyButtonsToCodeBlocks(scrollableDiv);
                } else {
        ...
        function doTTS(response) {
            ...
            const streamingUrl = `${ttsHost.value}/?text=${encodeURIComponent(response)}&voice=${voice}&language=en&output_file=${outputFile}`;
        ...
        onBeforeUnmount(() => {
            if (codeCopyObserver) {
                codeCopyObserver.disconnect();
                codeCopyObserver = null;
            }
        });
